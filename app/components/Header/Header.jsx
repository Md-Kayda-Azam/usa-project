...
const Header = () => {
  ...
  return (
    <motion.div
      className={`sticky top-0 z-50 bg-white shadow px-3 ${
        ...
        <div className="hidden sm:flex justify-center items-center space-x-5">
          <Link href="/">
            <button
              className={`${
                pathname === '/'
                  ? 'inline-flex justify-center w-full px-4 py-3 rounded-full text-sm font-medium border border-transparent shadow-sm focus:outline-none 0 bg-[#b81c1c] hover:bg-red-700 text-white'
                  : 'inline-flex justify-center w-full px-4 py-3 rounded-full text-sm font-medium text-black  border border-transparent shadow-sm focus:outline-none 0'
              }`}
            >
              Home
            </button>
